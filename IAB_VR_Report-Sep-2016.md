...
360度動画はどこから始まるか？
360度動画は、マウスのようなコントローラや、モバイルデバイスの加速度計などを利用したコンテンツナビゲーションにより、どんなスクリーンでも使用することが出来ます。
スクリーンは数フィート離れていても、顔に縛り付けられていても構いません。Figure 1 で示すように、ユーザの没入感のクオリティはVRプラットフォームで異なり、より単純な360度動画は真のVRと呼べるほどの水準に達しないです。

最終的に、「没入感」は広告主、パブリッシャー両方にとってのVRのキーワードです。
Publicis MediaのSVP Yale Cohen氏が語った最高の表現は、「私がデジタルビデオを見たいときはリビングルームのスクリーン上で見ることが出来ます。VRは、あなたがリビングルームにいるかわからないのでこのモデルを逆転させます。あなたはどこにでもいる可能性があります。」でした。
HuluのEmerging TechnologyのNoah Heller副社長は、「あなたがVRだと知るときは、誰かが感情をむき出しにしたリアクションをした時です。」と付け加えました。
没入感に特別なオーディオ、仮想世界の中で自身の手を見られること、自由に歩き回れることが必要かどうか議論されています。

Time Inc.のChris Hercikにとって、「真のVR」はより没入感の強い体験であり、それはユーザーがコンテンツと何らかの形でやりとりとりしながら、体験の進路を決められる事である。
彼にとって360度のビデオや写真の経験は必ずしもVRではない。
「私は、我々はこれらの2つを明確に区別する必要があると思います。広告主やパートナーと話している時に、片方は視点と周りを見渡す手段を用意するだけで、もう片方はより没入感があるからである。」
Time Inc.のMia Tramzは、メディアの未来は完全に没入型の体験であると付け加えた。 「360度のVR体験は、VRへの大きな入り口であり、消費者にそのメディアを知ってもらうためのものですが、より多くの没入とインタラクション（特にルームスケール）は明らかに魅力的です。

視力、音、動きによって消費者に届くように努力しているビデオのように、フォーマットに関係なくコンテンツの重要性を忘れないようにしましょう。 GoogleのAaron Luber氏は次のように指摘しました「モノラルビデオであろうと両眼視なビデオであろうと、我々は、どのようにストーリーを伝えているか？という同じ課題に答えようとしています。あなたは何を人々の注意を引くのですか？そしてそれはコンテンツが3Dであるかどうかとは何の関係もありません。
